...
This package is in its infancy and currently has basic functinonality and may be unstable, which is to say: use with caution. 
You can install the current version using `devtools::install_github("will-r-chase/afmr")`
